...
export class AudioQueue {
  ...
  /**
   * Invalidate the current request ID after an interruption.
   * Rejects any stale in-flight TTS responses that arrive after stopAll()
   * but before the next initializeTTS() call sets a proper new request.
   */
  invalidateRequest(newRequestId) {
    this.activeRequestId = newRequestId;
  }
